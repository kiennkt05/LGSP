...
def get_command_line_parser():
    ...
    parser.add_argument('-epochs_base', type=int, default=19)
    parser.add_argument('-epochs_new', type=int, default=5)
    parser.add_argument('-lr_base', type=float, default=0.012)
    ...
    parser.add_argument('-use_meta_optimizer', action='store_true', help='Use Deep Meta-Optimizer for Fast-Path')
    parser.add_argument('-meta_hidden_dim', type=int, default=256)
    parser.add_argument('-meta_lr', type=float, default=1e-3)
    parser.add_argument('-meta_snapshot_batches', type=int, default=1)
